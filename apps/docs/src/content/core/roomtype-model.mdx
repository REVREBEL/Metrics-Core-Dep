...
| ----------------------- | ----------------- | -------------------- | ----------------- |
| no_beds                 | 1                 | 2                    | 1                 |
| bedtype_code            | `KG`              | `QN`                 | `KG`              |
| roomclass_code          | `STD`             | `UPGRADE`            | `BEST`            |
| roomfeature_code        | `NONE`            | `NONE`               | `VIEW`            |
| roomcategory_code       | `SUITE`           | `ROOM`               | `ROOM`            |
| Generated roomtype code | `1KGSTDNONESUITE` | `2QNUPGRADENONEROOM` | `1KGBESTVIEWROOM` |
...
| no_beds                 | 1             | 2                |
| bedtype_code            | `KG`          | `QN`             |
| roomclass_code          | `STD`         | `UPGRADE`        |
| roomfeature_code        | `NONE`        | `NONE`           |
| roomcategory_code       | `SUITE`       | `ROOM`           |
| Generated roomtype code | `1KGSTDSUITE` | `2QNUPGRADEROOM` |
...
| ROOMPOOL                          | Group 1                       | Group 2                        |
| ------------------------------ | ----------------------------- | --------------------------------- |
| INCLUDED ROOMTYPE CODES        | `1KGSTDSUITE, 2QNUPGRADEROOM` | `1KGBESTVIEWROOM, 2QNUPGRADEROOM` |
| DIM_ROOMPOOL.CODE              | `1KGSTDSUITE2QNUPGRADEROOM`   | `1KGBESTVIEWROOM2QNUPGRADEROOM`   |
| DIM_ROOMPOOL.RELATED_ROOMTYPES | `1KGSTDSUITE,2QNUPGRADEROOM`  | `1KGBESTVIEWROOM,2QNUPGRADEROOM`  |
