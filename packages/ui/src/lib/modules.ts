...
const customComponentImportEntries: Record<string, string> = {};
for (const name of CUSTOM_COMPONENT_NAMES) {
  customComponentImportEntries[`@/components/${name}`] =
    `/playground/modules/components/${name}.js`;
}

const widgetImportEntries: Record<string, string> = {};
for (const name of WIDGET_NAMES) {
  widgetImportEntries[`@/widgets/${name}/index`] =
    `/playground/modules/widgets/${name}.js`;
}
...
export const importMap = {
  imports: {
    ...
    jotai: `${CDN}/jotai@2.17.1${reactExternal}`,
    "jotai/react": `${CDN}/jotai@2.17.1/react${reactExternal}`,
    "jotai/utils": `${CDN}/jotai@2.17.1/utils${reactExternal}`,
    "jotai/vanilla": `${CDN}/jotai@2.17.1/vanilla`,
    "jotai/react/utils": `${CDN}/jotai@2.17.1/react/utils${reactExternal}`,
    "@base-ui/react": "/playground/modules/base-ui.js",
    "@base-ui/react/merge-props": "/playground/modules/base-ui.js",
    "@base-ui/react/use-render": "/playground/modules/base-ui.js",
    "@base-ui/react/field": "/playground/modules/base-ui.js",
    "@base-ui/react/input": "/playground/modules/base-ui.js",
    "@base-ui/react/popover": "/playground/modules/base-ui.js",
    "@base-ui/react/tooltip": "/playground/modules/base-ui.js",
    "@base-ui/react/menu": "/playground/modules/base-ui.js",
    "@base-ui/react/form": "/playground/modules/base-ui.js",
    "@base-ui/react/slider": "/playground/modules/base-ui.js",
    "@base-ui/react/combobox": "/playground/modules/base-ui.js",
    "@base-ui/react/number-field": "/playground/modules/base-ui.js",
    "@base-ui/react/preview-card": "/playground/modules/base-ui.js",
    "@base-ui/react/scroll-area": "/playground/modules/base-ui.js",
    "@base-ui/react/separator": "/playground/modules/base-ui.js",
    "@base-ui/react/toast": "/playground/modules/base-ui.js",
    ...
    "@/components/ui": "/playground/modules/ui.js",
    ...uiImportEntries,
    ...customComponentImportEntries,
    ...widgetImportEntries,
  },
};
