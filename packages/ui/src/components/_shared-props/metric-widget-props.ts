...
export const metricWidgetImplementationExample = `import type { StandardMetricWidgetProps } from "@/components/metric-cards/props";
...
export const metricLayoutImplementationExample = `import { MetricLayout } from "@/components/metric-cards/_shared/MetricCard";
