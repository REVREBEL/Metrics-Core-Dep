...
function PopoverTrigger({ className, children, asChild = false, nativeButton, ...props }: PopoverPrimitive.Trigger.Props & { asChild?: boolean }) {
  const isLikelyButton = asChild || "render" in props;
  const finalNativeButton = nativeButton ?? isLikelyButton;
...
export { PopoverCreateHandle, Popover, PopoverTrigger, PopoverPopup, PopoverPopup as PopoverContent, PopoverHeader, PopoverTitle, PopoverDescription, PopoverClose, PopoverPrimitive };
