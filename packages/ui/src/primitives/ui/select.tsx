  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <IconChevronDown className='size-4 opacity-50' strokeWidth={1.5} size={20} />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <IconChevronUp className='size-4' strokeWidth={1.5} size={20} />
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <IconChevronDown className='size-4' strokeWidth={1.5} size={20} />
    </SelectPrimitive.ScrollDownButton>
  )
}
